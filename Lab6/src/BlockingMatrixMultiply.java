...
public class BlockingMatrixMultiply {
    private static final int rowsMatrixA = 500;
    private static final int columnsMatrixA = 500;
    private static final int rowsMatrixB = 500;
    private static final int columnsMatrixB = 500;
